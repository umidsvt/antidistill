...
def parse_args():
    ...
    parser.add_argument("--output_dir", default="./outputs_fewshot_1", type=str)
...
def infer(args):
    ...
    # Build prompt batch with optional prefix nudge
    prompt_batch = []
    for example in tqdm(examples, total=len(examples)):
        ...
        if args.surround_with_messages:
            ...
            # Append a prefix nudge to steer generation style
            cur_prompt = cur_prompt + "Okay, so I "
