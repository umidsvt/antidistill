...
**Status:** **G1 complete (2026-09-05); first attack complete (2026-09-06).** All three replication cells reproduce over 600 problems — LIMO +13.0 pp (paper: +13.4); hindsight collapses to 1/3 of base on AIME24 (paper: 1/4). The §4.3 supplementation attack then **defeats the defense at 50% epistemic traces (63.8% ≈ pure LIMO's 62.8%) but backfires at 10% (52.2%, below hindsight's 56.5%)**. Full write-up: `results/REPORT.md`. Next: `cutoff_len` control run, then M4 defense API.
